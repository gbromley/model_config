...
atm_data = '/glade/collections/rda/data/ds630.0/e5.oper.an.pl/'
sfc_data = '/glade/collections/rda/data/ds630.0/e5.oper.an.sfc/'
...
if (start_year < 2002 or end_year >= 2018 or start_year >= 2017 or end_year <= 2002):
